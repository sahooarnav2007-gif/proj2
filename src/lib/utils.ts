...
export const translations = {
  en: {
    ...
    bulkHrmsVerify: "Bulk HRMS / CSV Verification",
    pendingHrVerifications: "Pending HR Verifications",
    requires1Click: "Requires 1-click confirmation",
    verifiedThisQuarter: "Verified This Quarter",
    retention12M: "Average Retention at 12M",
    discrepancyResolution: "Discrepancy Resolution",
    aiSector: "Industry Sector",
    aiWage: "Monthly Net Wage",
    aiCommute: "Daily One-Way Commute",
    aiShift: "Shift Type",
    aiRelevance: "Training Relevance Score",
    aiStars: "Stars",
    aiJobMonths: "Months in Current Job",
    aiDistrict: "District (Model Context)",
    aiInformal: "Informal / Unregistered Contract",
    aiInformalHint: "Absence of active EPFO provident fund coverage increases exit risk",
    aiExitProbability: "Predicted Job Exit Probability",
    aiExitWithin90: "chance of exit within 90 days",
    aiInferencing: "AI Inferencing",
    aiRisk: "Risk",
    aiIntervention: "Automated Counselor Intervention Directive:",
    aiModelArch: "Model Architecture:",
  },
  mr: {
    ...
    printReport: "प्रिंट करा / PDF म्हणून जतन करा",
    bulkHrmsVerify: "बॅच HRMS / CSV पडताळणी",
    pendingHrVerifications: "प्रलंबित HR पडताळणी",
    requires1Click: "१-क्लिक पुष्टीकरण आवश्यक",
    verifiedThisQuarter: "या तिमाहीत सत्यापित",
    retention12M: "१२ महिन्यांची सरासरी टिकवणूक",
    discrepancyResolution: "वाद निवारण",
    aiSector: "उद्योग क्षेत्र",
    aiWage: "मासिक निव्वळ वेतन",
    aiCommute: "दैनंदिन एकेरी प्रवास",
    aiShift: "शिफ्ट प्रकार",
    aiRelevance: "प्रशिक्षण प्रासंगिकता गुण",
    aiStars: "तारे",
    aiJobMonths: "सध्याच्या नोकरीतील महिने",
    aiDistrict: "जिल्हा (मॉडेल संदर्भ)",
    aiInformal: "अनौपचारिक / अनोंदणीकृत करार",
    aiInformalHint: "सक्रिय EPFO प्रॉव्हिडंट फंड कव्हरेजची अनुपस्थिती नोकरी सोडण्याचा धोका वाढवते",
    aiExitProbability: "अंदाजित नोकरी सोडण्याची शक्यता",
    aiExitWithin90: "९० दिवसांत नोकरी सोडण्याची शक्यता",
    aiInferencing: "AI Inferencing",
    aiRisk: "धोका",
    aiIntervention: "आपोआप निर्माण झालेला सल्लागार हस्तक्षेप आदेश:",
    aiModelArch: "मॉडेल आर्किटेक्चर:",
  },
  hi: {
    appTitle: "स्किल सिंक (Skill Sync)",
    ...
    printReport: "प्रिंट करें / PDF के रूप में सेव करें",
    bulkHrmsVerify: "बल्क HRMS / CSV सत्यापन",
    pendingHrVerifications: "लंबित HR सत्यापन",
    requires1Click: "1-क्लिक पुष्टि आवश्यक",
    verifiedThisQuarter: "इस तिमाही में सत्यापित",
    retention12M: "12-माह औसत रोजगार स्थिरता",
    discrepancyResolution: "विवाद समाधान",
    aiSector: "उद्योग क्षेत्र",
    aiWage: "मासिक शुद्ध वेतन",
    aiCommute: "दैनिक एकतरफा आवागमन",
    aiShift: "शिफ्ट प्रकार",
    aiRelevance: "प्रशिक्षण प्रासंगिकता स्कोर",
    aiStars: "स्टार",
    aiJobMonths: "वर्तमान नौकरी में महीने",
    aiDistrict: "जिला (मॉडेल संदर्भ)",
    aiInformal: "अनौपचारिक / अपंजीकृत अनुबंध",
    aiInformalHint: "सक्रिय EPFO प्रोविडेंट फंड कवरेज की अनुपस्थिति से नौकरी छोड़ने का जोखिम बढ़ता है",
    aiExitProbability: "अनुमानित नौकरी छोड़ने की संभावना",
    aiExitWithin90: "90 दिनों में नौकरी छोड़ने की संभावना",
    aiInferencing: "AI Inferencing",
    aiRisk: "जोखिम",
    aiIntervention: "स्वचालित परामर्शदाता हस्तक्षेप निर्देश:",
    aiModelArch: "मॉडल आर्किटेक्चर:",
  }
};
